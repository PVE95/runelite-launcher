...
cp native/build-x86/src/Release/LuzoxPK.exe build/win-x86/
cp build/libs/LuzoxPK.jar build/win-x86/
...
echo LuzoxPK.exe 32bit sha256sum
sha256sum build/win-x86/LuzoxPK.exe

dumpbin //HEADERS build/win-x86/LuzoxPK.exe
