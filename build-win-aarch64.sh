...
cp native/build-aarch64/src/Release/LuzoxPK.exe build/win-aarch64/
cp build/libs/LuzoxPK.jar build/win-aarch64/
...
echo LuzoxPK.exe aarch64 sha256sum
sha256sum build/win-aarch64/LuzoxPK.exe

dumpbin //HEADERS build/win-aarch64/LuzoxPK.exe
