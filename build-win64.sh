...
cp native/build-x64/src/Release/LuzoxPK.exe build/win-x64/
cp build/libs/LuzoxPK.jar build/win-x64/
...
echo LuzoxPK.exe 64bit sha256sum
sha256sum build/win-x64/LuzoxPK.exe

dumpbin //HEADERS build/win-x64/LuzoxPK.exe
